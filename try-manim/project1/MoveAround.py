...
class Updaters(Scene):
    def construct(self):
        ...
        rec = RoundedRectangle(stroke_width =8, stroke_color= WHITE,
        ...
        mathtext.add_updater(lambda x: x.move_to(rec.get_center()))

        self.play(FadeIn(rec))
        self.play(Write(mathtext))
        self.play(rec.animate.shift(RIGHT*1.5 + DOWN *5), run_time =6)
        self.wait()
        mathtext.clear_updaters()
        self.play(rec.animate.shift(LEFT*2 +UP*1), run_time =6)
